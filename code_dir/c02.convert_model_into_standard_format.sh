...
# ==================================================
#	This Script is aimed at convert Tomo model into 
#	my own standard model format and store them
#	
...
cd $PWD/Maligaro/cpp_lib/FT_convert
make > & /dev/null 
cd $WORKDIR
cp $PWD/Maligaro/cpp_lib/FT_convert/forward_tomography .

echo "======================================================="
echo "======================================================="
echo "++++++++++++++++++++ Begin time +++++++++++++++++ `date`"
forward_tomography<< EOF 
$WORKDIR/LSM_record_input $MODEL_DIR/$MODEL $INFILE $MODEL 
EOF
echo "++++++++++++++++++++ End time +++++++++++++++++++ `date`"
echo "======================================================="
echo "======================================================="
...
cp $WORKDIR/${MODEL}.standard.model $MODEL_DIR/${MODEL}/
